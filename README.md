...
![Дашборд анализа продаж](dashboard_preview_1.png)
...
* **Коммерческий тренд:** После локального снижения выручки в декабре 2016 года маркетплейс демонстрирует устойчивый рост продаж. Средний чек (AOV) остается относительно стабильным, что свидетельствует об увеличении объема заказов, а не стоимости корзины.
...
- импорт исходных данных в PostgreSQL;
- разработка многотабличного SQL-запроса с использованием JOIN для объединения данных из нескольких связанных таблиц;
- подготовка плоской аналитической витрины с вычисляемыми полями (месяц заказа, срок доставки и др.);
- подключение Power BI к PostgreSQL в режиме Import;
- разработка интерактивного BI-дашборда;
- анализ коммерческих и логистических показателей и формулировка бизнес-выводов.
